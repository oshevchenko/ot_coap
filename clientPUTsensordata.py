...
async def main():
    ...
    payload = b'{"serial": "44443333", "devtype": "TempSensor", "value": "22.3"}'
    request = Message(code=PUT, payload=payload, uri="coap://localhost/sensordata")

    response = await context.request(request).response

    payload = b'{"serial": "44443333", "devtype": "EmergBtn", "value": "1"}'
    request = Message(code=PUT, payload=payload, uri="coap://localhost/sensordata")
